/**
 * original: https://github.com/microsoft/TypeScript/blob/main/eslint.config.mjs
 * modified:
 *   - disable all local defined rules
 *   - disable no-restricted-globals: allowing setTimeout etc. in src/** files
 * modified by: Ashitemaru
 */
// @ts-check
